    ...
    def __init__(self, source, logger):
        try:
            ...
            if source == 'local':
                ...
                clf_url = "https://raw.github.com/AnandBhatUpb/CPAchecker_dataset/master/clf_data_memsafety.csv"
                reg_url = "https://raw.github.com/AnandBhatUpb/CPAchecker_dataset/master/reg_data_memsafety.csv"
