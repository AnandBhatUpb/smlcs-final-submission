...
class Regressor:
    ...
    def local_training(self, environment, reg, X, Y, outercv, logger):
        try:
    ...
    def cluster_training(self, environment, reg, job_id, subjob_id, logger):
        try:
            ...
            X, Y = ReadData(datasource, logger).read_reg_data(logger)  # Read data from local/remote
